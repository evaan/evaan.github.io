var OnigurumaToEs=(()=>{var we=Object.defineProperty;var Lr=Object.getOwnPropertyDescriptor;var Pr=Object.getOwnPropertyNames;var Gr=Object.prototype.hasOwnProperty;var Ur=(e,r)=>{for(var t in r)we(e,t,{get:r[t],enumerable:!0})},Or=(e,r,t,n)=>{if(r&&typeof r=="object"||typeof r=="function")for(let o of Pr(r))!Gr.call(e,o)&&o!==t&&we(e,o,{get:()=>r[o],enumerable:!(n=Lr(r,o))||n.enumerable});return e};var Rr=e=>Or(we({},"__esModule",{value:!0}),e);var on={};Ur(on,{EmulatedRegExp:()=>se,toRegExp:()=>sn,toRegExpDetails:()=>Fr});var y=String.fromCodePoint,h=String.raw,P={flagGroups:(()=>{try{new RegExp("(?i:)")}catch{return!1}return!0})(),unicodeSets:(()=>{try{new RegExp("","v")}catch{return!1}return!0})()};P.bugLiteralHyphenIsRange=(()=>{if(!P.unicodeSets)return!1;try{new RegExp(h`[\d\-a]`,"v")}catch{return!0}return!1})();function j(e,{enable:r,disable:t}){return{dotAll:!t?.dotAll&&!!(r?.dotAll||e.dotAll),ignoreCase:!t?.ignoreCase&&!!(r?.ignoreCase||e.ignoreCase)}}function G(e,r,t){return e.has(r)||e.set(r,t),e.get(r)}function Y(e,r){return Ce[e]>=Ce[r]}function Re(e,r){if(e==null)throw new Error(r??"Value expected");return e}var Ce={ES2025:2025,ES2024:2024,ES2018:2018},Dr={auto:"auto",ES2025:"ES2025",ES2024:"ES2024",ES2018:"ES2018"};function ue(e={}){if({}.toString.call(e)!=="[object Object]")throw new Error("Unexpected options");if(e.target!==void 0&&!Dr[e.target])throw new Error(`Unexpected target "${e.target}"`);let r={accuracy:"default",avoidSubclass:!1,flags:"",global:!1,hasIndices:!1,lazyCompileLength:1/0,target:"auto",verbose:!1,...e,rules:{allowOrphanBackrefs:!1,asciiWordBoundaries:!1,captureGroup:!1,recursionLimit:20,singleline:!1,...e.rules}};return r.target==="auto"&&(r.target=P.flagGroups?"ES2025":P.unicodeSets?"ES2024":"ES2018"),r}function U(e){if([...e].length!==1)throw new Error(`Expected "${e}" to be a single code point`);return e.codePointAt(0)}function De(e,r,t){return e.has(r)||e.set(r,t),e.get(r)}var ee=new Set(["alnum","alpha","ascii","blank","cntrl","digit","graph","lower","print","punct","space","upper","word","xdigit"]),x=String.raw;function F(e,r){if(e==null)throw new Error(r??"Value expected");return e}var He=x`\[\^?`,je=`c.? | C(?:-.?)?|${x`[pP]\{(?:\^?[-\x20_]*[A-Za-z][-\x20\w]*\})?`}|${x`x[89A-Fa-f]\p{AHex}(?:\\x[89A-Fa-f]\p{AHex})*`}|${x`u(?:\p{AHex}{4})? | x\{[^\}]*\}? | x\p{AHex}{0,2}`}|${x`o\{[^\}]*\}?`}|${x`\d{1,3}`}`,be=/[?*+][?+]?|\{(?:\d+(?:,\d*)?|,\d+)\}\??/,ce=new RegExp(x`
  \\ (?:
    ${je}
    | [gk]<[^>]*>?
    | [gk]'[^']*'?
